...
<!-- Inline Icons -->
  ...
  <path stroke-linecap="round" stroke-linejoin="round"
        d="M3.75 3v18h16.5V3M3.75 13.5l4.5-4.5 3 3 4.5-4.5M3.75 3h16.5" />
</svg>
    <h4>Strategy</h4>
  </div>
  <div class="icon-wrap">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
     viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
     class="heroicon heroicon--globe">
  <path stroke-linecap="round" stroke-linejoin="round"
        d="M12 2.25c5.385 0 9.75 4.365 9.75 9.75S17.385 21.75 12 21.75 2.25 17.385 2.25 12 6.615 2.25 12 2.25zm0 0c2.121 0 4.136 4.365 4.136 9.75S14.121 21.75 12 21.75 7.864 17.385 7.864 12 9.879 2.25 12 2.25zM2.25 12h19.5" />
</svg>

    <h4 class="strategy-label">Visibility</h4>
  </div>
  <div class="icon-wrap">
...
<section class="text-block measure blobbed blob--md blob-right">
  ...
  <div class="icon-wrap">
    ...
    <p>Visualise your marketing performance through meaningful data insights.</p>
  </div>
  ...
  <i class="screen screen--grey-1"
   style="--screen-w:420px; --screen-h:260px; --screen-top:-30px; --screen-left:-60px; --screen-t:rotate(-2deg);"></i>

<i class="screen screen--grey-2"
   style="--screen-w:280px; --screen-h:180px; --screen-top:120px; --screen-left:55%; --screen-t:rotate(1.5deg);"></i>
...
<hr class="hr-shadow">
  ...
  <div class="text-block measure  blobbed blob--lg style-brick ivory">
