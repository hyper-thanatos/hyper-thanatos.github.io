...
(function(){
  ...
  let current = null;       // current <img> node
  let group = [];           // ordered NodeList of group members
  let index = 0;            // index within group
  let lastFocus = null;     // focus return target
  ...
  // Trap focus inside dialog (very light)
